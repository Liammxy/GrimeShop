...
// Consulta filtrando apenas produtos ativos (st_produto = 'ativo' ou st_produto IS NULL)
$sql_produtos = "SELECT p.*, c.nm_categoria 
                 FROM produto p 
                 INNER JOIN categoria c ON p.id_categoria = c.id_categoria 
                 WHERE p.st_produto = 'ativo' OR p.st_produto IS NULL";
        ...
        <div class="container my-4">
            ...
            <div class="row g-4">
                ...
                while($produto = $resultado->fetch_assoc()) {
                    // Pega o valor do preço independente de se a coluna chama vl_preco ou vl_produto
                    $preco = isset($produto['vl_preco']) ? $produto['vl_preco'] : (isset($produto['vl_produto']) ? $produto['vl_produto'] : 0);
                ?>
                    <div class="col-md-4" data-aos="fade-up">
                        <div class="card card-cursed p-3 h-100">
                            ...
                            <div class="card-body p-0 text-center mt-3">
                                ...
                                <p class="product-price">R$ <?php echo number_format($preco, 2, ',', '.'); ?></p>
