...
// 3. Busca APENAS os produtos da categoria 2 (Calçados / Coturnos)
$sql_calcados = "SELECT * FROM Produto WHERE id_categoria = 2";
$resultado = $conexao->query($sql_calcados);
?>
...
<main class="position-relative overflow-hidden pb-0 pt-0">
    ...
    <div class="container position-relative" style="z-index: 3;">
        ...
        <div class="container my-4">
            ...
            <h1 class="text-light text-center mb-5 text-uppercase" style="letter-spacing: 2px; font-weight: bold;" data-aos="fade-down">[ DROP_01 / CALÇADOS ]</h1>

            <div class="row g-4">
                
                <?php
                // Se encontrar calçados no banco, roda o laço idêntico ao do index
                ...
                <?php
                    ...
                    echo "<p class='text-light text-center w-100' style='z-index: 5;'>Nenhum calçado encontrado no momento.</p>";
                }
                ?>
