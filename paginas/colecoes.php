            ...
            <div class="card card-cursed p-3 h-100 position-relative overflow-hidden" style="background-color: #0c0c0c; border: 1px solid #ff0033; border-radius: 0px;">
                <div class="row align-items-center g-3">
                    ...
                    <div class="col-sm-7 text-center text-sm-start">
                        ...
                        <a href="camisas.php" class="btn btn-cursed w-100 text-uppercase" style="font-size: 0.85rem; letter-spacing: 1px;">Ver Produtos</a>
                    </div>
                </div>
            </div>
        </div>
            ...
            <div class="card card-cursed p-3 h-100 position-relative overflow-hidden" style="background-color: #0c0c0c; border: 1px solid #ff0033; border-radius: 0px;">
                <div class="row align-items-center g-3">
                    ...
                    <div class="col-sm-7 text-center text-sm-start">
                        ...
                        <a href="acessorios.php" class="btn btn-cursed w-100 text-uppercase" style="font-size: 0.85rem; letter-spacing: 1px;">Ver Produtos</a>
                    </div>
                </div>
            </div>
        </div>
